...
public class MessagePriveActivity extends Activity {
	...
	private String contenuConversation ="<br><u>Quentin (30/04/14 à 15h07)</u></br>"
			+ "<br>salut</br>"
			+ "<br><br/>"
			+ "<br><u>John (30/04/14 à 16h07)</u></br>"
			+ "<br>salut à toi</br>"
			+ "<br><br/>"
			+ "<br><u>Quentin (30/04/14 à 15h07)</u></br>"
			+ "<br>salut</br>"
			+ "<br><br/>"
			+ "<br><u>John (30/04/14 à 16h07)</u></br>"
			+ "<br>salut à toi</br>" 
	...
	public void envoyerMessage(View view){
		...
		contenuConversation = contenuConversation + "<br><br/>"
				+ "<br><u>Quentin (01/05/14 à 11h10)</u></br>"
				+ "<br>" +message +"</br>";
